...
class ResearchDashboardScatter extends StatelessWidget {
                  ...
                  titlesData: FlTitlesData(
                    ...
                    bottomTitles: AxisTitles(
                      ...
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize: 22,
                        interval: _yearInterval(minYear, maxYear),
                        getTitlesWidget: (v, _) => Text(
                          v.round().toString(),
                          style: TextStyle(
                              fontSize: 9,
  ...
  /// Khoảng cách nhãn năm để trục X không bị chen chữ.
  double _yearInterval(int minYear, int maxYear) {
    final span = (maxYear - minYear).abs();
    if (span <= 6) return 1;
    if (span <= 14) return 2;
    return (span / 6).ceilToDouble();
  }
}
